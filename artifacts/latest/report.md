...
![models landing (default trending sort)](screenshots/01_models-landing-default-trending-.png)

**after filter -> Text Generation** — `huggingface.co/models?pipeline_tag=text-generation&sort=trending`

![after filter -> Text Generation](screenshots/02_after-filter-text-generation.png)

**listing: Text Generation sorted by Most likes** — `huggingface.co/models?pipeline_tag=text-generation&sort=likes`

![listing: Text Generation sorted by Most likes](screenshots/03_listing-text-generation-sorted-b.png)

**after scroll** — `huggingface.co/models?pipeline_tag=text-generation&sort=likes`

![after scroll](screenshots/04_after-scroll.png)

**model 1: deepseek-ai/DeepSeek-R1** — `huggingface.co/deepseek-ai/DeepSeek-R1`

![model 1: deepseek-ai/DeepSeek-R1](screenshots/05_model-1-deepseek-ai-deepseek-r1.png)

**set-of-marks vision overlay — 18 candidate marks** — `huggingface.co/deepseek-ai/DeepSeek-R1`

![set-of-marks vision overlay — 18 candidate marks](screenshots/vision_marks_1.png)

**model 2: meta-llama/Meta-Llama-3-8B** — `huggingface.co/meta-llama/Meta-Llama-3-8B`

![model 2: meta-llama/Meta-Llama-3-8B](screenshots/06_model-2-meta-llama-meta-llama-3-.png)

**model 3: meta-llama/Llama-3.1-8B-Instruct** — `huggingface.co/meta-llama/Llama-3.1-8B-Instruct`

![model 3: meta-llama/Llama-3.1-8B-Instruct](screenshots/07_model-3-meta-llama-llama-3-1-8b-.png)
